...
describe('UserService', () => {
  ...
  describe('editProfile', () => {
    it('should change email', async () => {
      const oldUser = { email: 'test1', verified: true };
      const newUser = { email: 'test2', verified: false };
      const editProfileArgs = { userId: 1, input: { email: 'test2' } };
    ...
    it('should fail on exception', async () => {
      ...
      expect(result).toEqual({ ok: false, error: "Can't update profile" });
    });
  ...
  describe('verifyEmail', () => {
    ...
    it('should fail on exception', async () => {
      ...
      const result = await service.verifyEmail('code');
      expect(result).toEqual({ ok: false, error: "Can't verify email" });
    });
  });
});
